...
- [ax](ax/SKILL.md): curl эры AI — fetch, обнаружение структуры страницы и извлечение структурированных данных без одноразовых парсеров.
...
- [deep-research](deep-research/SKILL.md): профессиональная генерация глубоких исследовательских отчётов с параллельным написанием глав, новейшими данными, многоязычным выводом и встроенными проверками качества.
...
- [diagram-design](diagram-design/SKILL.md): editorial HTML/SVG-диаграммы 39 типов, brand tokens и перерисовка draw.io/Mermaid.
...
- Skill `ax` требует CLI `ax` (`curl -fsSL https://ax.yusuke.run/install | sh`).
- Skill `diagram-design` использует Python 3 для import extraction и встроенного self-check.
...
| ------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| [ax](ax/SKILL.md)                                                   | curl эры AI: fetch URL, обнаружение структуры страницы и извлечение структурированных данных без одноразовых парсеров.                                                              | [yusukebe/ax](https://github.com/yusukebe/ax/tree/main/skills/ax)                                                              |
...
| [deep-research](deep-research/SKILL.md)                             | Профессиональная генерация глубоких исследовательских отчётов с параллельным написанием глав, новейшими данными, многоязычным выводом и встроенными проверками качества.                  | [hoolulu/deep-research](https://github.com/hoolulu/deep-research)                                                               |
...
| [diagram-design](diagram-design/SKILL.md)                             | Editorial HTML/SVG/PNG-диаграммы 39 типов; brand tokens; перерисовка draw.io или Mermaid.                                                                                                | [cathrynlavery/diagram-design](https://github.com/cathrynlavery/diagram-design/tree/main/skills/diagram-design) |
