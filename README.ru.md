...
Для глобальных инструкций Claude Code или Codex начните с [`CLAUDE_AGENTS.md`](CLAUDE_AGENTS.md), затем скопируйте или объедините его с `CLAUDE.md` для Claude Code или `AGENTS.md` для Codex. Он включает Chinese-first и KISS-ориентированный workflow, проверки актуальной документации/source, предпочтение multi-agent, включенные по умолчанию `planning-with-files` / `karpathy-guidelines`, строгие ожидания к TypeScript и правила маршрутизации context-mode. Перед повторным использованием отредактируйте раздел `语言要求` под ваш проект. Раздел `其他注意项` намеренно является проектно-локальным и может редактироваться по мере необходимости.
...
- [ax](ax/SKILL.md): curl эры AI — fetch страниц, discovery структуры и structured extraction без одноразовых parse-скриптов.

### Planning & Prompting

- [planning-with-files](planning-with-files/SKILL.md): persistent markdown planning с `task_plan.md`, `findings.md` и `progress.md`.
- [product-decision-agent](product-decision-agent/SKILL.md): китаеязычный агент продуктовых решений для диагностики узких мест, приоритизации, роста, метрик, операций и межкомандной работы.
...
- [grilling](grilling/SKILL.md): reusable design-tree interview loop для прямых grill sessions.
...
- [diagram-design](diagram-design/SKILL.md): branded editorial-диаграммы как автономные HTML/SVG/PNG — architecture, flowchart, sequence и ещё 36 типов. Перерисовать draw.io или Mermaid.
...
| [ax](ax/SKILL.md)                                                   | curl эры AI: fetch URL, discovery структуры страницы и structured extraction из HTML без одноразовых parse-скриптов.                                                        | [yusukebe/ax](https://github.com/yusukebe/ax/tree/main/skills/ax)                                                             |
...
| [deep-research](deep-research/SKILL.md)                                       | Профессиональные deep-research отчёты с параллельным multi-agent написанием, актуальными данными, многоязычным выводом и встроенной проверкой качества. | [hoolulu/deep-research](https://github.com/hoolulu/deep-research/tree/main)                                                        |
| [diagram-design](diagram-design/SKILL.md)                           | Branded editorial HTML/SVG/PNG диаграммы (39 типов). Перерисовать draw.io или Mermaid.                                                               | [cathrynlavery/diagram-design](https://github.com/cathrynlavery/diagram-design/tree/main/skills/diagram-design)                 |
...
| [grilling](grilling/SKILL.md)                               | Reusable design-tree interview loop для прямых grill sessions.                                                                                                         | [mattpocock/skills](https://github.com/mattpocock/skills/tree/main/skills/productivity/grilling)                                |
...
| [product-decision-agent](product-decision-agent/SKILL.md)           | Китаеязычный агент продуктовых решений для диагностики узких мест, приоритизации, роста, метрик, операций и межкомандной работы.                                                          | [atdy/maoxuan-product-agent](https://github.com/atdy/maoxuan-product-agent/tree/main/product-decision-agent)                      |
