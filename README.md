...
- [deep-research](deep-research/SKILL.md): professional deep research report generation with parallel chapter writing, latest-data targeting, multilingual output, and built-in quality checks.
...
- [diagram-design](diagram-design/SKILL.md): editorial HTML/SVG diagrams across 39 types, with brand tokens and draw.io/Mermaid redraw.
...
| [deep-research](deep-research/SKILL.md)                             | Professional deep research report generation with parallel chapter writing, latest-data targeting, multilingual output, and built-in quality checks.                                 | [hoolulu/deep-research](https://github.com/hoolulu/deep-research)                                                               |
...
| [diagram-design](diagram-design/SKILL.md)                             | Editorial HTML/SVG/PNG diagrams across 39 types; onboard brand tokens; redraw draw.io or Mermaid sources.                                                                                                | [cathrynlavery/diagram-design](https://github.com/cathrynlavery/diagram-design/tree/main/skills/diagram-design) |
