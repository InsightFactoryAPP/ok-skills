...
- [ax](ax/SKILL.md): AI 時代の curl — ページ取得、構造発見、構造化抽出。使い捨てパーススクリプト不要。
...
- [diagram-design](diagram-design/SKILL.md): ブランドに合わせた編集品質の図を、単体で開ける HTML/SVG/PNG として作る。architecture、flowchart、sequence ほか 39 種。draw.io / Mermaid の再描画も可。
...
| [ax](ax/SKILL.md)                                                   | AI 時代の curl：URL 取得、ページ構造の発見、HTML からの構造化抽出。使い捨てパーススクリプト不要。                                                                                                                   | [yusukebe/ax](https://github.com/yusukebe/ax/tree/main/skills/ax)                                                             |
...
| [product-decision-agent](product-decision-agent/SKILL.md)           | 中国語優先のプロダクト意思決定 Agent。ボトルネック診断、優先順位付け、成長、指標、運用、部門横断の推進に対応。                                                                             | [atdy/maoxuan-product-agent](https://github.com/atdy/maoxuan-product-agent/tree/main/product-decision-agent)                      |
