...
- [deep-research](deep-research/SKILL.md): parallel chapter writing, latest-data targeting, multilingual output और built-in quality checks के साथ professional deep research report generation.
...
- [diagram-design](diagram-design/SKILL.md): 39 types के editorial HTML/SVG diagrams, brand tokens और draw.io/Mermaid redraw के साथ।
...
- `diagram-design` skill import extraction और packaged self-check के लिए Python 3 इस्तेमाल करता है।
...
| [deep-research](deep-research/SKILL.md)                             | Parallel chapter writing, latest-data targeting, multilingual output aur built-in quality checks ke saath professional deep research report generation.                              | [hoolulu/deep-research](https://github.com/hoolulu/deep-research)                                                               |
...
| [diagram-design](diagram-design/SKILL.md)                             | 39 types के editorial HTML/SVG/PNG diagrams; brand tokens; draw.io/Mermaid sources redraw.                                                                                                | [cathrynlavery/diagram-design](https://github.com/cathrynlavery/diagram-design/tree/main/skills/diagram-design) |
