...
- [ax](ax/SKILL.md): AI 시대의 curl. URL 가져오기, 페이지 구조 탐색, 구조화 데이터 추출을 일회성 파서 없이 수행.
...
- [deep-research](deep-research/SKILL.md): 병렬 장 작성, 최신 데이터 타기팅, 다국어 출력, 내장 품질 검사를 지원하는 전문 심층 연구 보고서 생성.
...
- [diagram-design](diagram-design/SKILL.md): 39종 에디토리얼 HTML/SVG 다이어그램. 브랜드 token과 draw.io/Mermaid 재작성 지원.
...
- `ax` skill은 `ax` CLI가 필요합니다(`curl -fsSL https://ax.yusuke.run/install | sh`).
- `diagram-design` skill의 import 추출과 self-check에는 Python 3가 필요합니다.
...
| Skill                                                               | 설명                                                                                                                                             | Source URL                                                                                                                     |
| ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
| [ax](ax/SKILL.md)                                                   | AI 시대의 curl. URL 가져오기, 페이지 구조 탐색, 구조화 데이터 추출을 일회성 파서 없이 수행.                                                                                        | [yusukebe/ax](https://github.com/yusukebe/ax/tree/main/skills/ax)                                                              |
