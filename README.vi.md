...
- [ax](ax/SKILL.md): curl thời AI — fetch, khám phá cấu trúc trang và trích xuất dữ liệu có cấu trúc mà không cần parser dùng một lần.
...
- [deep-research](deep-research/SKILL.md): tạo báo cáo nghiên cứu chuyên sâu với viết chương song song, nhắm dữ liệu mới nhất, đầu ra đa ngôn ngữ và kiểm tra chất lượng tích hợp.
- [diagnosing-bugs](diagnosing-bugs/SKILL.md): vong lap chan doan co ky luat cho bug kho va regression hieu nang.
- [grilling](grilling/SKILL.md): reusable one-question-at-a-time interview loop cho direct grill sessions.
...
- [diagram-design](diagram-design/SKILL.md): sơ đồ HTML/SVG editorial 39 loại, có brand token và vẽ lại draw.io/Mermaid.
...
- Skill `ax` cần CLI `ax` (`curl -fsSL https://ax.yusuke.run/install | sh`).
- Skill `diagram-design` dùng Python 3 cho trích xuất import và self-check đi kèm.
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
| [ax](ax/SKILL.md)                                                   | curl thời AI: fetch URL, khám phá cấu trúc trang và trích xuất dữ liệu có cấu trúc mà không cần parser dùng một lần.                                                                   | [yusukebe/ax](https://github.com/yusukebe/ax/tree/main/skills/ax)                                                              |
...
| [deep-research](deep-research/SKILL.md)                             | Tạo báo cáo nghiên cứu chuyên sâu với viết chương song song, nhắm dữ liệu mới nhất, đầu ra đa ngôn ngữ và kiểm tra chất lượng tích hợp.             | [hoolulu/deep-research](https://github.com/hoolulu/deep-research)                                                               |
...
| [diagram-design](diagram-design/SKILL.md)                             | Sơ đồ HTML/SVG/PNG editorial 39 loại; brand token; vẽ lại nguồn draw.io hoặc Mermaid.                                                                                                | [cathrynlavery/diagram-design](https://github.com/cathrynlavery/diagram-design/tree/main/skills/diagram-design) |
...
| [grilling](grilling/SKILL.md)                               | Reusable one-question-at-a-time interview loop cho direct grill sessions.                                                                                              | [mattpocock/skills](https://github.com/mattpocock/skills/tree/main/skills/productivity/grilling)                                |
